...
rozšiřujícího mapové publikační platformu Gisquick o podporu práce s
časoprostorovými daty. Nástroj nabídne uživateli přehledné uživatelské
rozhraní, které umožní selekci mapových prvků vektorových vrstev na
základě jejich časových hodnot. Selekci bude zároveň možné provádět
...
Druhá část se zabývá implementací nalezeného řešení v platformě
...
úpravy webového klienta bylo dále nutné zahrnout novou funkcionalitu
