...
'YYYY-MM-DDTHH\newline:mm:SS', kdy je použit znak 'T' oddělující
...
%% DT: doplneno
časového formátu \textit{UNIX TIME}\footnote{\textit{UNIX Time} je systém pro identifikaci časového okamžiku. Jedná se o počet sekund, které uplynuly od 1. ledna 1970}. Z těchto hodnot
