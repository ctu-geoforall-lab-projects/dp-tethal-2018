...
definuje \uv{mapu} jako digitální vyobrazení geografických informací,
...
%% ML: seznam (dale v textu!), dokonce ten hruby anglikanismus i
%% sklonujes...
...
\item\textit{FORMAT} - nastavení formátu výstupního souboru (mapového
  ...
  %% ML: nezapomen rozepsat zkratky v ``seznamu zkratek'', idealni by
  %% mely byt v pdf prokliky, ale to uz ted neres
...
%% ML: spise nez o sluzbu se jedna o serverovou aplikaci/kompomenentu
...
%% ML: ta prvni veta moc nedava smysl
...
%% ML: vysvetlit do poznamky pod carou, co si predstavujes pod ``cloudem''
ArcGIS online nabízí uživatelům publikování projektu přímo do cloudové
%% ML: spolecnost je ESRI
...
%% linky by nemely byt ``na pevno'' ale dynamicke, \ref{} + \label{}
...
%% ML: daty?
%% Prvni vetu rozdelit, druhou cast prepsat
...
%% ML: odkaz na kapitolu o WMS, vysvetlit dalsi standardy (poznamka pod carou?)
%% ML: standardy
...
%% ML: vyhoda popsana na konci prechozi casti, to neni uplne zrejme,
%% rozepis, aby to bylo jasnejsi...
